export default function about() {
  return (
    <>
      <main className="flex dark:bg-black h-screen">
        <div className="relative grid h-screen w-screen max-w-[28rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
